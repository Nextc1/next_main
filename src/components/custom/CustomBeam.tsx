...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-border p-3",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex flex-row items-stretch justify-between max-w-2xl gap-10 size-full">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <div className="flex flex-row items-center justify-between px-20 py-3 md:px-8 gap-x-4 md:gap-x-20 rounded-xl bg-gamma min-w-max">
              <div className="flex flex-row items-center gap-x-4">
                <FontAwesomeIcon icon={faUserCheck} />
                <p className="text-md md:text-xl">Fractional Ownership, Full Potential</p>
              </div>
            </div>
          </Circle>
          <Circle ref={div2Ref}>
        ...
        <div className="flex flex-col justify-center">
          <div className="z-20 flex flex-row items-center justify-between px-20 py-3 bg-black md:px-8 gap-x-4 md:gap-x-20 rounded-xl">
            <div className="flex flex-row items-center gap-x-4">
              <p className="font-bold text-white text-md md:text-2xl">Next Carbon</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col justify-center">
